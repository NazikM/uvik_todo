...
async def echo_message(message: types.Message):
    ...
    if user_state == 'main':
        ...
        task_id = await db.add_task(title=message.text, telegram_id=telegram_id)
        ...
        if message.text != 'skip':
            ...
            await db.update_task(description=message.text, task_id=task_id, telegram_id=telegram_id)
